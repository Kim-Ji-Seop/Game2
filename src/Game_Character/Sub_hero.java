...
public class Sub_hero extends Hero{
    public Sub_hero(String name, int Hp, int Mp, int physical_attack_power, int magical_attack_power, int physical_defense,
        ...
        super(name, Hp, Mp, physical_attack_power, magical_attack_power, physical_defense, magical_defense, Class,
    ...
    public void Special_Skill(Character target1, Character target2, Character target3, Character target4, Character enemy){ // 전투에서 한번밖에 쓸 수 없는 특수스킬
        ...
        if(this.Class.equals("신성단장")){
            target1.Hp = target1.Hp + 3000;
            target2.Hp = target2.Hp + 3000;
            target3.Hp = target3.Hp + 3000;
            target4.Hp = target4.Hp + 3000;
        }
    }
